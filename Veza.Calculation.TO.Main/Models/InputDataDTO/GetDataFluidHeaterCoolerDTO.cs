...
{
    public class GetDataFluidHeaterCoolerDTO
    {
        /// <summary>
        ...
        /// </summary>
        public List<string> ListFluids { get; set; }
        /// <summary>
        /// Концентрация гликоля
        /// </summary>
        public string I_SoleCnz { get; set; }
        /// <summary>
        /// Концентрация гликоля граничные условия
        /// </summary>
        public List<int> I_SoleCnzMinMax { get; set; } = new List<int> { 0, 100 };
        /// <summary>
        /// Температура теплоносителя на входе
        /// </summary>
        public string ValueMedTempIn { get; set; }
        /// <summary>
        /// Температура теплоносителя на входе граничные условия
        /// </summary>
        public List<int> ValueMedTempInMinMax { get; set; } = new List<int> { -50, 300 };
        /// <summary>
        ...
        /// </summary>
        public List<string> ListVariantRasch { get; set; }
        /// <summary>
        /// Максимальное падение давления
        /// </summary>
        public string ValueMedKPa { get; set; }
        /// <summary>
        /// Максимальное падение давления граничные условия
        /// </summary>
        public List<int> ValueMedKPaMinMax { get; set; } = new List<int> { -50, 300 };
        ...
        /// </summary>
        public List<int> I_HdrQtaMinMax { get; set; } = new List<int> { 0, 100 };
        /// <summary>
        /// Материал коллектора
        /// </summary>
