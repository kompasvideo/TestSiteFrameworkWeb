...
{
    public class GetDataEvaporaterDTO
    {
        /// <summary>
        ...
        /// список - температура кипения или давление кипения абс.
        /// </summary>
        public List<string> ListEvaporatingTemperature { get; set; }
        /// <summary>
        /// Температура кипения
        /// </summary>
        public string I_TEvapDX { get; set; }
        /// <summary>
        /// Температура кипения граничные условия
        /// </summary>
        public List<int> I_TEvapDXMinMax { get; set; } = new List<int> { -100, 200 };
        /// <summary>
        /// давление кипения абс.
        /// </summary>
        public string EvapAbsPresDX { get; set; }
        /// <summary>
        /// давление кипения граничные условия
        /// </summary>
        public List<int> EvapAbsPresDXMinMax { get; set; } = new List<int> { -100, 200 };
        /// <summary>
        ...
        /// Список перегрев всас. газа или температура всас. газа
        /// </summary>
        public List<string> ListSuctOvrheat { get; set; }
        /// <summary>
        /// температура всас. газа
        /// </summary>
        public string I_TOvrHDX { get; set; }
        /// <summary>
        /// Температура всас газа граничные условия
        /// </summary>
        public List<int> I_TOvrHDXMinMax { get; set; } = new List<int> { -100, 200 };
        /// <summary>
        /// перегрев всас. газа
        /// </summary>
        public string SuctGasReturnDX { get; set; }
        /// <summary>
        /// Перегрев всас газа граничные условия
        /// </summary>
        public List<int> SuctGasReturnDXMinMax { get; set; } = new List<int> { -100, 200 };
        /// <summary>
        ...
        /// </summary>
        public List<int> I_TCondDXMinMax { get; set; } = new List<int> { -100, 200 };
        /// <summary>
        ...
        /// </summary>
        public List<int> CondAbsPresDXMinMax { get; set; } = new List<int> { -100, 200 };
        /// <summary>
        ...
        /// </summary>
        public List<int> I_TSubCDXMinMax { get; set; } = new List<int> { -100, 200 };
        /// <summary>
        ...
        /// </summary>
        public List<int> LiquidTempDXMinMax { get; set; } = new List<int> { -100, 200 };
        /// <summary>
        /// Количество контуров хладогента
        /// </summary>
        public string I_RCircDX { get; set; }
        /// <summary>
        /// Количество контуров хладогента граничные условия
        /// </summary>
        public List<int> I_RCircDXMinMax { get; set; } = new List<int> { 0, 100 };
        /// <summary>
        /// Пропускная способность байпаса
        /// </summary>
        public string I_DxBypDX { get; set; }
        /// <summary>
        /// пропускная способность байпаса граничные условия
        /// </summary>
        public List<int> I_DxBypDXMinMax { get; set; } = new List<int> { 0, 100 };
