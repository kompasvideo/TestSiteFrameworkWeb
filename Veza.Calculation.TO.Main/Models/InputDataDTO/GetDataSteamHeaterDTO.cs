...
{
    public class GetDataSteamHeaterDTO
    {
        /// <summary>
        ...
        /// </summary>
        public string DirectAirTempOutST { get; set; }
        /// <summary>
        /// Геометрия
        /// </summary>
        ...
        /// <summary>
        /// Давление пара граничные условия
        /// </summary>
        public List<int> I_StmBarMinMax { get; set; } = new List<int> { 0, 1_000 };
        /// <summary>
        /// Температура пара
        /// </summary>
        public string I_StmTemp { get; set; }
        /// <summary>
        /// Температура пара граничные условия
        /// </summary>
        public List<int> I_StmTempMinMax { get; set; } = new List<int> { 0, 1_000 };
